...
export class ProductsComponent implements OnInit, AfterViewInit  {
  products: PeriodicElement[] = [
    {_id: 'sdsfadf', name: 'hsdskdj', categoryId: 'hsjdhsd', imageUrl: 'akjshbd', price: '45', quantity: 4}
  ]
  displayedColumns: string[] = ['position', 'name', 'quantity', 'price', 'action'];
  dataSource = new MatTableDataSource<PeriodicElement>(this.products);
